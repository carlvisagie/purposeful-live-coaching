...
const COACHES = [
  ...
  },
  {
    ...
    gender: "female",
    specialties: ["Emotional Support", "Relationship Coaching", "Self-Care & Wellness", "Anxiety Management", "Women's Health", "Family Dynamics", "Stress Relief", "Mindfulness"],
    bio: "Compassionate wellness coach with a nurturing approach, specializing in emotional wellbeing, family dynamics, and helping clients build resilience through mindfulness and self-care practices.",
    image: null,
    available: true,
  },
];
