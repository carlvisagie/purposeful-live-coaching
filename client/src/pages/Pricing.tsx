...
export default function Pricing() {
  ...
  const aiTiers = [
    ...
    },
    {
      ...
      features: [
        "Everything in Basic",
        "All 34 wellness modules unlocked (vs 5 in Basic)",
        "500 AI messages per month (vs 100 in Basic)",
    ...
    },
    {
      ...
      features: [
        ...
        "Text & email support (vs email only in Premium)",
        "Priority support with SAME-DAY response guarantee",
        "Proactive AI check-ins & wellness monitoring",
      ],
    },
  ];
