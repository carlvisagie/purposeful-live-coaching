  ...
  const aiTiers = [
    ...
    },
    {
      ...
      features: [
        ...
        "5 evidence-based wellness foundations",
        "Reduce stress & anxiety with proven techniques",
        "Build sustainable habits (21-day neural rewiring)",
    ...
    },
    {
      ...
      features: [
        "Everything in Basic",
        "All 34 wellness modules (complete transformation system)",
        "Deeper support for complex challenges",
        "Identify patterns holding you back",
        "Personalized action plans for lasting change",
        "Faster response when you're struggling",
    ...
    },
    {
      ...
      features: [
        ...
        "Unlimited support for your journey",
        "Fully personalized to your unique situation",
        "Comprehensive life planning (career, relationships, purpose)",
        "Predictive insights to prevent setbacks",
        "Custom strategies for your specific goals",
        "Family wellness support (help your loved ones too)",
        "Text & email support when you need it",
        "Same-day response guarantee (never feel alone)",
        "Proactive check-ins to keep you on track",
  ...
  const humanTiers = [
    ...
    },
    {
      ...
      features: [
        ...
        "24/7 AI coaching between sessions",
        "Priority scheduling",
        "Email & scheduled phone consultations",
    ...
    },
    {
      ...
      name: "Elite",
      price: 2000,
      description: "8 sessions + priority coach access",
      icon: <Crown className="h-6 w-6" />,
      color: "border-amber-500",
      popular: false,
      features: [
        "8 live sessions per month (60 min each)",
        "24/7 AI coaching + priority coach texting",
        "Email, text & priority phone access",
        "Direct coach contact (text/email)",
